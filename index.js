...
function getnotans() {
    ...
    if (!found)
        document.getElementById("notoutputdisp").innerHTML = "Wrong Input type, Input Binary Numbers";
    else document.getElementById("notoutputdisp").innerHTML = "Output - " + ans;
}
...
function getorans() {
    ...
    if (!found)
        document.getElementById("oroutputdisp").innerHTML = "Wrong Input, Input Binary Numbers";
    else 
        document.getElementById("oroutputdisp").innerHTML = "Output - " + ans;
}
...
function getnorans() {
    ...
    if (!found)
        document.getElementById("noroutputdisp").innerHTML = "Wrong Input, Input Binary Numbers";
    else 
        document.getElementById("noroutputdisp").innerHTML = "Output - " + ans;
}
...
function getxorans() {
    ...
    if (!found)
        document.getElementById("xoroutputdisp").innerHTML = "Wrong Input, Input Binary Numbers";
    else 
        document.getElementById("xoroutputdisp").innerHTML = "Output - " + ans;
}
...
function getandans() {
    ...
    if (!found)
        document.getElementById("andoutputdisp").innerHTML = "Wrong Input, Input Binary Numbers";
    else 
        document.getElementById("andoutputdisp").innerHTML = "Output - " + ans;
}
...
function getnandans() {
    ...
    if (!found)
        document.getElementById("nandoutputdisp").innerHTML = "Wrong Input, Input Binary Numbers";
    else 
        document.getElementById("nandoutputdisp").innerHTML = "Output - " + ans;
}
